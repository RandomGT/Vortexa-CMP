...
import com.vortexa.ui.page.teach.helper.ReserveCancelHeroDisplay
import com.vortexa.ui.page.teach.helper.ReserveCancelHeroMessage
import com.vortexa.ui.page.teach.helper.isReserveStatusCancelled
import com.vortexa.ui.page.teach.helper.parseTeachingEpochMilli
...
import com.vortexa.ui.page.teach.helper.resolveReserveCancelHeroDisplay

internal fun parseCourseStartEpochMilli(courseStartTime: String): Long? {
    return parseTeachingEpochMilli(courseStartTime)
}
...
data class OrderDetailUi(
    ...
    fun shouldShowEnterCourseButton(): Boolean {
        ...
        return currentTeachingEpochMillis() < end
    }
