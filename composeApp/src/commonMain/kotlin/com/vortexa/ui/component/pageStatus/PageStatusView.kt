...
import vortexa.composeapp.generated.resources.icon_empty
import vortexa.composeapp.generated.resources.icon_error
...
fun PageStatusView(
    ...
    onRefresh: (() -> Unit)? = null,
    failIconRes: DrawableResource = Res.drawable.icon_error,
    emptyIconRes: DrawableResource = Res.drawable.icon_empty
) {
    when (status) {
        PageStatus.Success -> {
            // 成功状态隐藏视图，不渲染任何内容
