...
/** 他人主页动态区 Tab：发帖、回复 */
val OtherUserProfileTabs = listOf("发帖", "回复")

/**
 * 他人主页 TabBar：发帖 / 回复 + 底部指示条（与钱包页 [com.vortexa.ui.page.wallet.WalletTabBar] 一致）。
 */
@Composable
fun OtherUserProfileTabBar(
    ...
    Box(modifier = modifier) {
        Row(
            ...
            OtherUserProfileTabs.forEachIndexed { index, title ->
                HomeHeaderTabItem(
                    text = title,
...
@Composable
private fun OtherUserProfileTabBarPreview() {
    BaseTheme {
        OtherUserProfileTabBar(selectedIndex = 0, onTabClick = {})
    }
}
