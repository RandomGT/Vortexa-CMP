...
/**
 * 钱包页 TabBar：三 Tab（全部/获得/支出）+ 底部指示条，参考 [com.vortexa.ui.page.teach.myclass.MyClassTabBar]。
 *
...
@Composable
@Preview
private fun WalletTabBarPreview() {
    WalletTabBar(selectedIndex = 0, onTabClick = {})
}
