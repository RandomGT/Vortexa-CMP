...
/** 校园页 Tab 文案：导师在线指导、涡联学院 */
val SchoolTabs = listOf("导师在线指导")

/**
 * 校园页 TabBar：两 Tab + 底部蓝色指示条，样式与 [com.vortexa.ui.page.search.result.SearchResultTabBar] 一致。
 *
...
fun SchoolTabBar(
    ...
    Box(modifier = modifier) {
        Row(
            ...
            SchoolTabs.forEachIndexed { index, title ->
                SchoolTabItem(
                    index = index,
                    title = title,
